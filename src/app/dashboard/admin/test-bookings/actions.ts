  ...
  try {
    ...
    if (prepareParticipantTicket) {
      ...
      redirectWithParams({
        ...
        customerReceiptDocumentId: paymentResult.customerReceiptDocumentId,
        customerReceiptPdfPath: paymentResult.customerReceiptPdfPath ?? "",
        customerReceiptPdfGenerated: paymentResult.customerReceiptPdfGenerated ? "yes" : "no",
        customerReceiptPdfWarning: paymentResult.customerReceiptPdfWarning ?? "",
        ticketId: ticketResult.ticketId,
