          ...
          {isDone ? (
            ...
            <div className="grid gap-3">
              <Link href={resolvedCheckIn.scanHref} className="rounded-2xl border p-4 text-sm transition hover:border-foreground/30">
                ...
                <p className="mt-1 text-muted-foreground">Scanner fuer den passenden Termin oeffnen.</p>
              </Link>
              <Link href={resolvedCheckIn.showHref} className="rounded-2xl border p-4 text-sm transition hover:border-foreground/30">
                ...
                <p className="mt-1 text-muted-foreground">Session-QR fuer Selbst-Check-in anzeigen.</p>
              </Link>
              <button
                type="button"
                disabled={pending}
              ...
              >
                ...
                <p className="mt-1 text-muted-foreground">
                  Fuer diese konkrete Person direkt als anwesend markieren.
                </p>
              </button>
            </div>
          )}
