...
const DOCUMENT_TYPE_LABELS: Record<FinancialDocumentRecord["document_type"], string> = {
  ...
  provider_payout_statement: "Auszahlungsabrechnung",
                ...
                <details className="mt-4 rounded-2xl border border-slate-200 bg-white p-4">
                  ...
                  <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      disabled
                      aria-disabled="true"
                      className="inline-flex cursor-not-allowed items-center justify-center rounded-2xl border border-slate-200 bg-slate-100 px-4 py-2 text-sm font-medium text-slate-500"
                    >
                      PDF folgt
                    </button>
                  </div>
